...
<body>
    <div class='container mt-5'>
        <div class='alert alert-success' role='alert'>
            ...
            <p>Your messaging application database has been created successfully.</p>
            <hr>
            <p class='mb-0'>You can now <a href='index.php' class='alert-link'>start using the application</a>.</p>
